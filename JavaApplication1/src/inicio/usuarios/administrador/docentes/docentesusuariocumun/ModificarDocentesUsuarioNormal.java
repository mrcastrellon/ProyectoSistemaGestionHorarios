 ...
 * @author BENJAMIN
 */
public class ModificarDocentesUsuarioNormal extends javax.swing.JFrame {

    /**
     * Creates new form INTERFAZ
     */
    public ModificarDocentesUsuarioNormal() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel12.setText("Modificar Docentes");

        jLabel13.setFont(new java.awt.Font("Arial Black", 0, 11)); // NOI18N
        jLabel13.setText("Selecciona el Docente a Eliminar");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ModificarDocentesUsuarioNormal().setVisible(true);
            }
        });
    }
