 ...
 * @author BENJAMIN
 */
public class ConsultarHorarioDocente extends javax.swing.JFrame {

    /**
     * Creates new form INTERFAZ
     */
    public ConsultarHorarioDocente() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConsultarHorarioDocente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ConsultarHorarioDocente().setVisible(true);
            }
        });
    }
