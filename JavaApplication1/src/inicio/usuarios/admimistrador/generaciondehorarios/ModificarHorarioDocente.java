 ...
 * @author BENJAMIN
 */
public class ModificarHorarioDocente extends javax.swing.JFrame {

    /**
     * Creates new form INTERFAZ
     */
    public ModificarHorarioDocente() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ModificarHorarioDocente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ModificarHorarioDocente().setVisible(true);
            }
        });
    }
