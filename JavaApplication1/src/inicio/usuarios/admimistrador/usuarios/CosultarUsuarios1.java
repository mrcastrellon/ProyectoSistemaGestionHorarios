 ...
 * @author BENJAMIN
 */
public class CosultarUsuarios extends javax.swing.JFrame {

    /**
     * Creates new form INTERFAZ
     */
    public CosultarUsuarios() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CosultarUsuarios.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CosultarUsuarios().setVisible(true);
            }
        });
    }
